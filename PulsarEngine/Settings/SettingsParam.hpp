...
enum MiscSettingItemsOnMinimap {
    MISCSETTING_ITEMS_ON_MINIMAP_DISABLED = 0x0,
    MISCSETTING_ITEMS_ON_MINIMAP_ENABLED = 0x1
};

enum MiscSettingChargeJump {
    MISCSETTING_CHARGE_JUMP_DISABLED = 0x0,
    MISCSETTING_CHARGE_JUMP_ENABLED = 0x1
};
...
enum FreeRoamSettingStartItem {
    FREEROAMSETTING_START_ITEM_MUSHROOM = 0x0,
